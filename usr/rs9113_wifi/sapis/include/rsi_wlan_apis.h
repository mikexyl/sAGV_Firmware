...
//! To Use PUF
#define CUSTOM_FEAT_PUF_ENABLE			     BIT(30)
...
extern uint16_t rsi_wlan_register_callbacks(uint32_t callback_id, void (*callback_handler_ptr)(uint16_t status, const uint8_t *buffer, const uint16_t length));

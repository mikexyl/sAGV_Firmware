...
#define RSI_SET_REGION_AP_FROM_USER        RSI_ENABLE    
...
//! scan channel bit map in 2.4GHz band,valid if given channel to scan is 0
#define RSI_CONFIG_CLIENT_SCAN_FEAT_BITMAP               1
...
#define RSI_CONFIG_P2P_TCP_IP_FEAT_BIT_MAP        BIT(4)
...
//! Set device name
#define RSI_CONFIG_P2P_DEVICE_NAME                    "REDPINE_AP"

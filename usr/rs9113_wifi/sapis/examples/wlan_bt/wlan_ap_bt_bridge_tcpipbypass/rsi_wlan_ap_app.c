 ...
 *
 *  @brief : This file contains wlan related operations to create ap and to perform a simple chat with BT device
 *
...
#ifdef RSI_WITH_OS
extern rsi_semaphore_handle_t wlan_thread_sem,bt_thread_sem;
#endif

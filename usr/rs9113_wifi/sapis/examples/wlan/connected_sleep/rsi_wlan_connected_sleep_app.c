 ...
 *
 *  @brief : This file contains example application for power save in connected sleep mode.
 *  @section Description  This file contains example application for power save in connected sleep mode.
 *
 *
 */
/**
...
#define NUMBER_OF_PACKETS 500000

 ...
 *
 *  @brief : This file contains example application for instant bgscan
 *
 *  @section Description  This file contains example application for instant bgscan 
 *
 *
 */
...
int32_t rsi_instant_bgscan()
{
  ...
  status = rsi_wlan_bgscan_profile(RSI_INSTANT_BGSCAN, bgscan_results, APP_BUFF_LEN);
  if(status != RSI_SUCCESS)
  {
    return status;
  }

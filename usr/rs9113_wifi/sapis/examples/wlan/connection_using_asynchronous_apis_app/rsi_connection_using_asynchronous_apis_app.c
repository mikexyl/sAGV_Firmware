 ...
 *
 *  @brief : This file contains example application for connection with async scan and connect apis
 *
 *  @section Description  This file contains example application for connection with asyn apis and TCP data transfer functionality 
 *
 *
 */

    ...
    case RSI_WLAN_SOCKET_CONNECTED_STATE:
      {
        ...
        {
          //! send data on socket
          status = udp_send(REMOTE_PORT, rsi_wlan_app_cb.ble_buffer, rsi_wlan_app_cb.ble_pkt_length);
...
//! To receive packet from Wlan station and forward it to BLE device 

...
static uint8_t  rsi_ble_app_data[20];
...
void rsi_ble_on_adv_report_event(rsi_ble_event_adv_report_t *adv_report)
{
  ...
  LOG_PRINT ("\n DEV_ADDR: %s\r\n", str_adv_addr);
  if ((!strcmp (RSI_BLE_DEV_1_ADDR, str_adv_addr)) || 
      (!strcmp (RSI_BLE_DEV_2_ADDR, str_adv_addr)) ||
      (!strcmp (RSI_BLE_DEV_3_ADDR, str_adv_addr)) ||
      (!strcmp (RSI_BLE_DEV_4_ADDR, str_adv_addr)) ||
      (!strcmp (RSI_BLE_DEV_5_ADDR, str_adv_addr)) ||
      (!strcmp (RSI_BLE_DEV_6_ADDR, str_adv_addr)) ||
      (!strcmp (RSI_BLE_DEV_7_ADDR, str_adv_addr)) ||
      (!strcmp (RSI_BLE_DEV_8_ADDR, str_adv_addr))) {
    ...
    case RSI_BLE_ADV_REPORT_EVENT:
      {
        ...
        if(conn_req_pending == 0)
        {
          ...
          {
            if((!strcmp(conn_dev_addr, RSI_BLE_DEV_1_ADDR)) || 
               (!strcmp(conn_dev_addr, RSI_BLE_DEV_2_ADDR)) ||
               (!strcmp(conn_dev_addr, RSI_BLE_DEV_3_ADDR)) ||
               (!strcmp(conn_dev_addr, RSI_BLE_DEV_4_ADDR)) ||
               (!strcmp(conn_dev_addr, RSI_BLE_DEV_5_ADDR)) ||
               (!strcmp(conn_dev_addr, RSI_BLE_DEV_6_ADDR)) ||
               (!strcmp(conn_dev_addr, RSI_BLE_DEV_7_ADDR)) ||
               (!strcmp(conn_dev_addr, RSI_BLE_DEV_8_ADDR)))
            {
              ...
              LOG_PRINT("\n Connect command \n");
              status = rsi_ble_connect(RSI_BLE_DEV_ADDR_TYPE, conn_dev_addr);
              if(status != RSI_SUCCESS)
              {
                return status;
              }
    ...
    case RSI_BLE_CONN_EVENT:
      {
        ...
        else if(!strcmp(conn_dev_addr, RSI_BLE_DEV_2_ADDR))
        {
          rsi_ble_app_set_event (RSI_BLE_SLAVE2_START_NOTIFY);
        }
        else if(!strcmp(conn_dev_addr, RSI_BLE_DEV_3_ADDR))
        {
          rsi_ble_app_set_event (RSI_BLE_SLAVE3_START_NOTIFY);
        }
        else if(!strcmp(conn_dev_addr, RSI_BLE_DEV_4_ADDR))
        {
          rsi_ble_app_set_event (RSI_BLE_SLAVE4_START_NOTIFY);
        }
        else if(!strcmp(conn_dev_addr, RSI_BLE_DEV_5_ADDR))
        {
          rsi_ble_app_set_event (RSI_BLE_SLAVE5_START_NOTIFY);
        }
        else if(!strcmp(conn_dev_addr, RSI_BLE_DEV_6_ADDR))
        {
          rsi_ble_app_set_event (RSI_BLE_SLAVE6_START_NOTIFY);
        }
        else if(!strcmp(conn_dev_addr, RSI_BLE_DEV_7_ADDR))
        {
          rsi_ble_app_set_event (RSI_BLE_SLAVE7_START_NOTIFY);
        }
        else if(!strcmp(conn_dev_addr, RSI_BLE_DEV_8_ADDR))
        {
          rsi_ble_app_set_event (RSI_BLE_SLAVE8_START_NOTIFY);
        }

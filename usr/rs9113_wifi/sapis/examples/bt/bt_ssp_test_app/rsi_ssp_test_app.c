 ...
 *
 *  @brief : This file contains example application for ssp level connection with remote devices
 *
 *  @section Description  This application serves as a ssp level conection .
 *
 */
      ...
      case RSI_APP_EVENT_SPP_CONN:
        {
          ...
          /* here we call the sniff_mode command*/
					rsi_bt_sniff_mode(str_conn_bd_addr,0xC0,0xA0,0x04,0x02);
